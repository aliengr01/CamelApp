...
class MainViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        vc.changePosition(minYPosition: counterStack.frame.origin.y + 80, maxYPosition: counterCell.frame.height - 5, explainYPosition: counterStack.frame.origin.y + 70, explainText: NSLocalizedString("Number of notifications with feedback", comment: "Количество уведомлений, на которые вы отреагировали, открыв приложение" ))
        vc.delegate = self
